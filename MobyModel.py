...
moby_sents = gutenberg.raw(gutenberg.fileids()[12])
moby_sents = moby_sents.split('\n')
print("The length of the sentences before cleaning is: ", len(moby_sents))
...
model_moby = Word2Vec(sentences, min_count = 1, size = 50, workers = 3, window = 5, sg = 0)
wv = model_moby.wv
